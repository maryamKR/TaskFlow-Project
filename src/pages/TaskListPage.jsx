                ...
                <div className={`rounded-xl overflow-hidden border ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                    <table className="w-full">
                        ...
                        <tbody>
                            {filtered.length === 0 ? (
                                <tr>
                                    <td colSpan={7} className={`px-4 py-8 text-center text-sm ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                                        No tasks found.
                                    </td>
                                </tr>
                            ) : (
                                filtered.map((task, i) => (
                                    ...
                                    >
                                        ...
                                        {/* Priority */}
                                        <td className="px-4 py-3">
                                            <span className={`text-xs px-2 py-1 rounded-full font-medium ${priorityColors[task.priority]} ${priorityBg[task.priority]}`}>
                                                {task.priority}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-4 py-3">
                                            {task.dueDate ? (
                                                <span className={`text-xs font-medium ${new Date(task.dueDate) < new Date() && !task.isDone
                                                    ? 'text-red-400'
